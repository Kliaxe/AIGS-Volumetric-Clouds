...
public:
    ...
    enum class MipGenFilter : GLenum;
...
public:
    ...
    // Generate a mipmap chain with a specific filtering policy
    void GenerateMipChain(MipGenFilter filter);
...
enum class TextureObject::MipGenFilter : GLenum
{
    MIPGENFILTER_NEAREST = GL_NEAREST_MIPMAP_NEAREST,
    MIPGENFILTER_LINEAR = GL_LINEAR_MIPMAP_LINEAR,
};
